...
public class UserController {
     ...
     * 根据用户名查询用户信息
     */
    @GetMapping("/api/shortlink/v1/admin/user/{username}")
     ...
     * 根据用户名查询未脱敏用户信息
     */
    @GetMapping("/api/shortlink/v1/admin/user/actual/{username}")
     ...
     * 查询用户名是否已存在
     */
    @GetMapping("/api/shortlink/v1/admin/user/has-username")
     ...
     *
     */
    @DeleteMapping("/api/shortlink/v1/admin/user/check-login")
