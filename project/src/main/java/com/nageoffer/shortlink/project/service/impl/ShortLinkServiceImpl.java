...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper,ShortLinkDO> implements ShortLinkService {
        ...
        */
        ...
        try {
            ...
            if(shortLinkDO != null){
                ...
                shortLinkStats(shortLinkDO.getFullShortUrl(),shortLinkDO.getGid(),buildLinkStatsRecordAndSetUser(fullShortUrl, request, response));
    ...
    private String generateSuffix(ShortLinkCreateReqDTO requestParam){
        ...
        while(true){
            ...
            if(!shortUriCreateBloomFilter.contains(createShortLinkDefaultDomain + ":8001" + "/" + shortUri)){
                break;
            }
            customGenerateCount++;
        }
